...
public class Cosmatics extends JFrame {
	...
	public Cosmatics() {
		...
		SellLbl = new JLabel("Sell Cosmatics");
		...
		SellLbl.setBounds(411, 11, 161, 39);
		contentPane.add(SellLbl);
		
		table = new JTable();
		table.setBounds(384, 111, 624, 533);
		...
		calendar.setBounds(75, 390, 198, 153);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				bill= q*pp;
				String query="UPDATE  cosmatics SET stock= '"+newQuan+"' WHERE id='"+currID+"'";
		...
		btnNewButton.setBounds(110, 322, 119, 46);
