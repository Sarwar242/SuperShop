...
public class Daily2 extends JFrame {
	...
	public Daily2() {
		...
		table = new JTable();
		table.setBounds(408, 103, 616, 544);
		...
		calendar.setBounds(104, 413, 198, 153);
		...
		BuyLabel.setBounds(316, 11, 263, 27);
		...
		lblBuyPriceperUnit.setBounds(17, 263, 183, 27);
		...
		BuyPrice.setBounds(194, 273, 150, 27);
		...
		stock.setBounds(184, 225, 160, 27);
		...
		BuyBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				bill= q*buyprice;
				String query="UPDATE  daily SET stock= '"+newQuan+"', buyprice='"+buyprice+"' WHERE id='"+currID+"'";
		...
		BuyBtn.setBounds(150, 345, 119, 46);
		...
		btnNewButton_3.setBounds(99, 616, 89, 31);
		...
		btnNewButton_4.setBounds(213, 616, 89, 31);
